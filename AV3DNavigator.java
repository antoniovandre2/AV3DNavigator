        ...
        for (int i = 0; i < EspacoLinhas.length; i++)
            ...
            if (ApfloatFlag == 0)
                ...
                try
                    ...
                    double ProdutoEscalaro = xo * Math.cos(Tetat) * Math.cos(Phit) * Math.signum(Math.cos(Phit)) - yo * Math.sin(Tetat) * Math.cos(Phit) - zo * Math.sin(Phit) * Math.signum(Math.cos(Phit));
                ...
                try
                    ...
                    Apfloat ProdutoEscalaroa = xoa.multiply(ApfloatMath.cos(new Apfloat(Tetat))).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(Math.signum(ApfloatMath.cos(new Apfloat(Phit)).doubleValue()))).add(yoa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1))).add(zoa.multiply(ApfloatMath.sin(new Apfloat(Phit))).multiply(new Apfloat(-1)).multiply(new Apfloat(Math.signum(ApfloatMath.cos(new Apfloat(Phit)).doubleValue()))));
