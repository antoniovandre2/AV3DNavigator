					...
					if (keyCode == KeyEvent.VK_NUMPAD4)
						...
						try
							...
							do
								{
								Linha = br.readLine();
								if (Linha != null) LinhasCam = LinhasCam + Linha + "\n";
								} while (Linha != null);
							} catch (IOException e) {}
