        ...
        while(Sair == 0)
            ...
            if (MouseDown == 0)
                ...
                if (ContadorFrames < FramesDeslocamento)
                    ...
                    if (Tetat > Teta)
                        {
                        Tetat -= Math.signum(Math.cos(Tetat)) * DeslocamentoAngular / FramesDeslocamento; FlagAlteracaoStatus = 1;
                        }
    ...
    public void DesenharEspaco(AV3DNavigator comp)
        ...
        for (int i = 0; i < EspacoLinhas.length; i++)
            ...
            if (ApfloatFlag == 0)
                ...
                try
                    {
                    xi = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * DistanciaTela * (Math.cos(Rott) * Math.signum(Math.cos(Tetat)) * (xo * Math.sin(Tetat) + yo * Math.cos(Tetat)) * Math.cos(Phit) / (Math.sqrt(xo * xo + yo * yo + zo * zo) * (Math.cos(Tetat) * Math.cos(Phit) - Math.sin(Tetat) * Math.cos(Phit))) - Math.sin(Rott) * Math.signum(Math.cos(Tetat)) * (xo * Math.cos(Tetat) * Math.sin(Phit) - yo * Math.sin(Tetat) * Math.sin(Phit) + zo * Math.cos(Phit)) / (Math.sqrt(xo * xo + yo * yo + zo * zo) * (Math.cos(Tetat) * Math.cos(Phit) - Math.sin(Tetat) * Math.cos(Phit))))) - CorrecaoX;

                    yi = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * DistanciaTela * (Math.sin(Rott) * Math.signum(Math.cos(Tetat)) * (xo * Math.sin(Tetat) + yo * Math.cos(Tetat)) * Math.cos(Phit) / (Math.sqrt(xo * xo + yo * yo + zo * zo) * (Math.cos(Tetat) * Math.cos(Phit) - Math.sin(Tetat) * Math.cos(Phit))) + Math.cos(Rott) * Math.signum(Math.cos(Tetat)) * (xo * Math.cos(Tetat) * Math.sin(Phit) - yo * Math.sin(Tetat) * Math.sin(Phit) + zo * Math.cos(Phit)) / (Math.sqrt(xo * xo + yo * yo + zo * zo) * (Math.cos(Tetat) * Math.cos(Phit) - Math.sin(Tetat) * Math.cos(Phit))))) - CorrecaoY;

                    xf = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * DistanciaTela * (Math.cos(Rott) * Math.signum(Math.cos(Tetat)) * (xd * Math.sin(Tetat) + yd * Math.cos(Tetat)) * Math.cos(Phit) / (Math.sqrt(xd * xd + yd * yd + zd * zd) * (Math.cos(Tetat) * Math.cos(Phit) - Math.sin(Tetat) * Math.cos(Phit))) - Math.sin(Rott) * Math.signum(Math.cos(Tetat)) * (xd * Math.cos(Tetat) * Math.sin(Phit) - yd * Math.sin(Tetat) * Math.sin(Phit) + zd * Math.cos(Phit)) / (Math.sqrt(xd * xd + yd * yd + zd * zd) * (Math.cos(Tetat) * Math.cos(Phit) - Math.sin(Tetat) * Math.cos(Phit))))) - CorrecaoX;
            
                    yf = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * DistanciaTela * (Math.sin(Rott) * Math.signum(Math.cos(Tetat)) * (xd * Math.sin(Tetat) + yd * Math.cos(Tetat)) * Math.cos(Phit) / (Math.sqrt(xd * xd + yd * yd + zd * zd) * (Math.cos(Tetat) * Math.cos(Phit) - Math.sin(Tetat) * Math.cos(Phit))) + Math.cos(Rott) * Math.signum(Math.cos(Tetat)) * (xd * Math.cos(Tetat) * Math.sin(Phit) - yd * Math.sin(Tetat) * Math.sin(Phit) + zd * Math.cos(Phit)) / (Math.sqrt(xd * xd + yd * yd + zd * zd) * (Math.cos(Tetat) * Math.cos(Phit) - Math.sin(Tetat) * Math.cos(Phit))))) - CorrecaoY;
                    ...
                    if ((Math.signum(Math.cos(Phi)) * Math.acos(ProdutoEscalaro / Math.sqrt(xo * xo + yo * yo + zo * zo)) < AnguloVisao + MargemAnguloVisao) && ((Math.signum(Math.cos(Phit)) * Math.acos(ProdutoEscalard / Math.sqrt(xd * xd + yd * yd + zd * zd)) < AnguloVisao + MargemAnguloVisao) && (Math.min(xi, Math.min(yi, Math.min(xf, yf))) > 0) && (Math.max(xi + CorrecaoX, Math.max(yi + CorrecaoY, Math.max(xf + CorrecaoX, yf + CorrecaoY))) < Math.min(TamanhoPlanoX, TamanhoPlanoY))))
                ...
                try
                    {
                    xi = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * ((new Apfloat(DistanciaTela)).multiply(ApfloatMath.cos(new Apfloat(Rott)).multiply(new Apfloat(Math.signum(Math.cos(Tetat)))).multiply(xoa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).add(yoa.multiply(ApfloatMath.cos(new Apfloat(Tetat)))).multiply(ApfloatMath.cos(new Apfloat(Phit))).divide(ApfloatMath.sqrt(xoa.multiply(xoa).add(yoa.multiply(yoa)).add(zoa.multiply(zoa))).multiply(ApfloatMath.cos(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).add(ApfloatMath.sin(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))).add(ApfloatMath.sin(new Apfloat(Rott)).multiply(new Apfloat(Math.signum(Math.cos(Tetat)))).multiply(xoa.multiply(ApfloatMath.cos(new Apfloat(Tetat))).multiply(ApfloatMath.sin(new Apfloat(Phit))).add(yoa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(ApfloatMath.sin(new Apfloat(Phit))).multiply(new Apfloat(-1))).add(zoa.multiply(ApfloatMath.cos(new Apfloat(Phit))))).divide(ApfloatMath.sqrt(xoa.multiply(xoa).add(yoa.multiply(yoa)).add(zoa.multiply(zoa))).multiply(ApfloatMath.cos(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).add(ApfloatMath.sin(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))))).doubleValue()) - CorrecaoX;
    
                    yi = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * ((new Apfloat(DistanciaTela)).multiply(ApfloatMath.sin(new Apfloat(Rott)).multiply(new Apfloat(Math.signum(Math.cos(Tetat)))).multiply(xoa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).add(yoa.multiply(ApfloatMath.cos(new Apfloat(Tetat)))).multiply(ApfloatMath.cos(new Apfloat(Phit))).divide(ApfloatMath.sqrt(xoa.multiply(xoa).add(yoa.multiply(yoa)).add(zoa.multiply(zoa))).multiply(ApfloatMath.cos(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).add(ApfloatMath.sin(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))).add(ApfloatMath.cos(new Apfloat(Rott)).multiply(new Apfloat(Math.signum(Math.cos(Tetat)))).multiply(xoa.multiply(ApfloatMath.cos(new Apfloat(Tetat))).multiply(ApfloatMath.sin(new Apfloat(Phit))).add(yoa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(ApfloatMath.sin(new Apfloat(Phit))).multiply(new Apfloat(-1))).add(zoa.multiply(ApfloatMath.cos(new Apfloat(Phit))))).divide(ApfloatMath.sqrt(xoa.multiply(xoa).add(yoa.multiply(yoa)).add(zoa.multiply(zoa))).multiply(ApfloatMath.cos(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).add(ApfloatMath.sin(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))))).doubleValue()) - CorrecaoY;
                        
                    xf = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * ((new Apfloat(DistanciaTela)).multiply(ApfloatMath.cos(new Apfloat(Rott)).multiply(new Apfloat(Math.signum(Math.cos(Tetat)))).multiply(xda.multiply(ApfloatMath.sin(new Apfloat(Tetat))).add(yda.multiply(ApfloatMath.cos(new Apfloat(Tetat)))).multiply(ApfloatMath.cos(new Apfloat(Phit))).divide(ApfloatMath.sqrt(xda.multiply(xda).add(yda.multiply(yda)).add(zda.multiply(zda))).multiply(ApfloatMath.cos(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).add(ApfloatMath.sin(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))).add(ApfloatMath.sin(new Apfloat(Rott)).multiply(new Apfloat(Math.signum(Math.cos(Tetat)))).multiply(xda.multiply(ApfloatMath.cos(new Apfloat(Tetat))).multiply(ApfloatMath.sin(new Apfloat(Phit))).add(yda.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(ApfloatMath.sin(new Apfloat(Phit))).multiply(new Apfloat(-1))).add(zda.multiply(ApfloatMath.cos(new Apfloat(Phit))))).divide(ApfloatMath.sqrt(xda.multiply(xda).add(yda.multiply(yda)).add(zda.multiply(zda))).multiply(ApfloatMath.cos(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).add(ApfloatMath.sin(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))))).doubleValue()) - CorrecaoX;
        
                    yf = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * ((new Apfloat(DistanciaTela)).multiply(ApfloatMath.sin(new Apfloat(Rott)).multiply(new Apfloat(Math.signum(Math.cos(Tetat)))).multiply(xda.multiply(ApfloatMath.sin(new Apfloat(Tetat))).add(yda.multiply(ApfloatMath.cos(new Apfloat(Tetat)))).multiply(ApfloatMath.cos(new Apfloat(Phit))).divide(ApfloatMath.sqrt(xda.multiply(xda).add(yda.multiply(yda)).add(zda.multiply(zda))).multiply(ApfloatMath.cos(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).add(ApfloatMath.sin(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))).add(ApfloatMath.cos(new Apfloat(Rott)).multiply(new Apfloat(Math.signum(Math.cos(Tetat)))).multiply(xda.multiply(ApfloatMath.cos(new Apfloat(Tetat))).multiply(ApfloatMath.sin(new Apfloat(Phit))).add(yda.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(ApfloatMath.sin(new Apfloat(Phit))).multiply(new Apfloat(-1))).add(zda.multiply(ApfloatMath.cos(new Apfloat(Phit))))).divide(ApfloatMath.sqrt(xda.multiply(xda).add(yda.multiply(yda)).add(zda.multiply(zda))).multiply(ApfloatMath.cos(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).add(ApfloatMath.sin(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))))).doubleValue()) - CorrecaoY;
                    ...
                    if ((ApfloatMath.acos(ProdutoEscalaroa.divide(ApfloatMath.sqrt(xoa.multiply(xoa).add(yoa.multiply(yoa)).add(zoa.multiply(zoa))))).multiply(new Apfloat(Math.signum(ApfloatMath.cos(new Apfloat(Phit)).doubleValue()))).doubleValue() < AnguloVisao + MargemAnguloVisao) && (ApfloatMath.acos(ProdutoEscalarda.divide(ApfloatMath.sqrt(xda.multiply(xda).add(yda.multiply(yda)).add(zda.multiply(zda))))).multiply(new Apfloat(Math.signum(ApfloatMath.cos(new Apfloat(Phit)).doubleValue()))).doubleValue() < AnguloVisao + MargemAnguloVisao) && (ApfloatMath.min(new Apfloat(xi), ApfloatMath.min(new Apfloat(yi), ApfloatMath.min(new Apfloat(xf), new Apfloat(yf)))).doubleValue() > 0) && (ApfloatMath.max(new Apfloat(xi + CorrecaoX), ApfloatMath.max(new Apfloat(yi + CorrecaoY), ApfloatMath.max(new Apfloat(xf + CorrecaoX), new Apfloat(yf + CorrecaoY)))).doubleValue() < ApfloatMath.min(new Apfloat(TamanhoPlanoX), new Apfloat(TamanhoPlanoY)).doubleValue()))
                        comp.addLine(xi, yi, xf, yf, CorLinhas);
                    }
                catch (Exception e) {}
                }
        ...
        for (int i = 0; i < EspacoPoligonosShapePreenchidos.length; i++)
            ...
            for (int j = 0; j < Pontos.length; j++)
                ...
                if (ApfloatFlag == 0)
                    ...
                    try
                        {
                        xpp = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * DistanciaTela * (Math.cos(Rott) * Math.signum(Math.cos(Tetat)) * (xp * Math.sin(Tetat) + yp * Math.cos(Tetat)) * Math.cos(Phit) / (Math.sqrt(xp * xp + yp * yp + zp * zp) * (Math.cos(Tetat) * Math.cos(Phit) - Math.sin(Tetat) * Math.cos(Phit))) - Math.sin(Rott) * Math.signum(Math.cos(Tetat)) * (xp * Math.cos(Tetat) * Math.sin(Phit) - yp * Math.sin(Tetat) * Math.sin(Phit) + zp * Math.cos(Phit)) / (Math.sqrt(xp * xp + yp * yp + zp * zp) * (Math.cos(Tetat) * Math.cos(Phit) - Math.sin(Tetat) * Math.cos(Phit))))) - CorrecaoX;
        
                        ypp = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * DistanciaTela * (Math.sin(Rott) * Math.signum(Math.cos(Tetat)) * (xp * Math.sin(Tetat) + yp * Math.cos(Tetat)) * Math.cos(Phit) / (Math.sqrt(xp * xp + yp * yp + zp * zp) * (Math.cos(Tetat) * Math.cos(Phit) - Math.sin(Tetat) * Math.cos(Phit))) + Math.cos(Rott) * Math.signum(Math.cos(Tetat)) * (xp * Math.cos(Tetat) * Math.sin(Phit) - yp * Math.sin(Tetat) * Math.sin(Phit) + zp * Math.cos(Phit)) / (Math.sqrt(xp * xp + yp * yp + zp * zp) * (Math.cos(Tetat) * Math.cos(Phit) - Math.sin(Tetat) * Math.cos(Phit))))) - CorrecaoY;
        
                        double ProdutoEscalar = xp * Math.cos(Tetat) * Math.cos(Phit) - yp * Math.sin(Tetat) * Math.cos(Phit);

                        if ((Math.signum(Math.cos(Phit)) * Math.acos(ProdutoEscalar / Math.sqrt(xp * xp + yp * yp + zp * zp)) < AnguloVisao + MargemAnguloVisao) && ((Math.min(xpp, ypp) > 0) && (Math.max(xpp + CorrecaoX, ypp + CorrecaoY)) < Math.min(TamanhoPlanoX, TamanhoPlanoY)))
                            {
                            ContadorPontos++;
                    ...
                    try
                        {
                        xpp = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * ((new Apfloat(DistanciaTela)).multiply(ApfloatMath.cos(new Apfloat(Rott)).multiply(new Apfloat(Math.signum(Math.cos(Tetat)))).multiply(xpa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).add(ypa.multiply(ApfloatMath.cos(new Apfloat(Tetat)))).multiply(ApfloatMath.cos(new Apfloat(Phit))).divide(ApfloatMath.sqrt(xpa.multiply(xpa).add(ypa.multiply(ypa)).add(zpa.multiply(zpa))).multiply(ApfloatMath.cos(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).add(ApfloatMath.sin(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))).add(ApfloatMath.sin(new Apfloat(Rott)).multiply(new Apfloat(Math.signum(Math.cos(Tetat)))).multiply(xpa.multiply(ApfloatMath.cos(new Apfloat(Tetat))).multiply(ApfloatMath.sin(new Apfloat(Phit))).add(ypa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(ApfloatMath.sin(new Apfloat(Phit))).multiply(new Apfloat(-1))).add(zpa.multiply(ApfloatMath.cos(new Apfloat(Phit))))).divide(ApfloatMath.sqrt(xpa.multiply(xpa).add(ypa.multiply(ypa)).add(zpa.multiply(zpa))).multiply(ApfloatMath.cos(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).add(ApfloatMath.sin(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))))).doubleValue()) - CorrecaoX;
        
                        ypp = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * ((new Apfloat(DistanciaTela)).multiply(ApfloatMath.sin(new Apfloat(Rott)).multiply(new Apfloat(Math.signum(Math.cos(Tetat)))).multiply(xpa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).add(ypa.multiply(ApfloatMath.cos(new Apfloat(Tetat)))).multiply(ApfloatMath.cos(new Apfloat(Phit))).divide(ApfloatMath.sqrt(xpa.multiply(xpa).add(ypa.multiply(ypa)).add(zpa.multiply(zpa))).multiply(ApfloatMath.cos(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).add(ApfloatMath.sin(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))).add(ApfloatMath.cos(new Apfloat(Rott)).multiply(new Apfloat(Math.signum(Math.cos(Tetat)))).multiply(xpa.multiply(ApfloatMath.cos(new Apfloat(Tetat))).multiply(ApfloatMath.sin(new Apfloat(Phit))).add(ypa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(ApfloatMath.sin(new Apfloat(Phit))).multiply(new Apfloat(-1))).add(zpa.multiply(ApfloatMath.cos(new Apfloat(Phit))))).divide(ApfloatMath.sqrt(xpa.multiply(xpa).add(ypa.multiply(ypa)).add(zpa.multiply(zpa))).multiply(ApfloatMath.cos(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).add(ApfloatMath.sin(new Apfloat(Tetat)).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))))).doubleValue()) - CorrecaoY;
                        ...
                        if ((ApfloatMath.acos(ProdutoEscalara.divide(ApfloatMath.sqrt(xpa.multiply(xpa).add(ypa.multiply(ypa)).add(zpa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(zpa))))).multiply(new Apfloat(Math.signum(ApfloatMath.cos(new Apfloat(Phit)).doubleValue()))).doubleValue() < AnguloVisao + MargemAnguloVisao) && ((Math.min(xpp, ypp) > 0) && (Math.max(xpp + CorrecaoX, ypp + CorrecaoY)) < Math.min(TamanhoPlanoX, TamanhoPlanoY)))
                            {
                            ContadorPontos++;
                            Poligono.addPoint(xpp, ypp);
                            }
