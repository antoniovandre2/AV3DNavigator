    ...
    public void DesenharEspaco(AV3DNavigator comp)
        ...
        for (int i = 0; i < EspacoLinhas.length; i++)
            ...
            if (ApfloatFlag == 0)
                ...
                try
                    {
                    xi = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * DistanciaTela * (Math.cos(Rott) * (xo * Math.sin(Tetat) + yo * Math.cos(Tetat)) / (xo * Math.cos(Tetat) - yo * Math.sin(Tetat)) / Math.max(Math.pow(Math.abs(Math.cos(Tetat)), FatorCorrecaoAspectoTeta), 1 / FatorMaxCorrecaoAspectoTeta) - Math.sin(Rott) * (zo + Math.sqrt(xo * xo + yo * yo) * Math.tan(Phit)) / (xo * Math.cos(Tetat) - yo * Math.sin(Tetat)) / Math.max(Math.pow(Math.abs(Math.cos(Phit)), FatorCorrecaoAspectoPhi), 1 / FatorMaxCorrecaoAspectoPhi))) - CorrecaoX;

                    yi = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * DistanciaTela * (Math.sin(Rott) * (xo * Math.sin(Tetat) + yo * Math.cos(Tetat)) / (xo * Math.cos(Tetat) - yo * Math.sin(Tetat)) / Math.max(Math.pow(Math.abs(Math.cos(Tetat)), FatorCorrecaoAspectoTeta), 1 / FatorMaxCorrecaoAspectoTeta) + Math.cos(Rott) * (zo + Math.sqrt(xo * xo + yo * yo) * Math.tan(Phit)) / (xo * Math.cos(Tetat) - yo * Math.sin(Tetat)) / Math.max(Math.pow(Math.abs(Math.cos(Phit)), FatorCorrecaoAspectoPhi), 1 / FatorMaxCorrecaoAspectoPhi))) - CorrecaoY;

                    xf = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * DistanciaTela * (Math.cos(Rott) * (xd * Math.sin(Tetat) + yd * Math.cos(Tetat)) / (xd * Math.cos(Tetat) - yd * Math.sin(Tetat)) / Math.max(Math.pow(Math.abs(Math.cos(Tetat)), FatorCorrecaoAspectoTeta), 1 / FatorMaxCorrecaoAspectoTeta) - Math.sin(Rott) * (zd + Math.sqrt(xd * xd + yd * yd) * Math.tan(Phit)) / (xd * Math.cos(Tetat) - yd * Math.sin(Tetat)) / Math.max(Math.pow(Math.abs(Math.cos(Phit)), FatorCorrecaoAspectoPhi), 1 / FatorMaxCorrecaoAspectoPhi))) - CorrecaoX;
            
                    yf = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * DistanciaTela * (Math.sin(Rott) * (xd * Math.sin(Tetat) + yd * Math.cos(Tetat)) / (xd * Math.cos(Tetat) - yd * Math.sin(Tetat)) / Math.max(Math.pow(Math.abs(Math.cos(Tetat)), FatorCorrecaoAspectoTeta), 1 / FatorMaxCorrecaoAspectoTeta) + Math.cos(Rott) * (zd + Math.sqrt(xd * xd + yd * yd) * Math.tan(Phit)) / (xd * Math.cos(Tetat) - yd * Math.sin(Tetat)) / Math.max(Math.pow(Math.abs(Math.cos(Phit)), FatorCorrecaoAspectoPhi), 1 / FatorMaxCorrecaoAspectoPhi))) - CorrecaoY;
                ...
                try
                    {
                    xi = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * (new Apfloat(DistanciaTela)).multiply(ApfloatMath.cos(new Apfloat(Rott)).multiply(xoa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).add(yoa.multiply(ApfloatMath.cos(new Apfloat(Tetat)))).divide(xoa.multiply(ApfloatMath.cos(new Apfloat(Tetat))).add(yoa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(new Apfloat(-1))))).divide(ApfloatMath.max(ApfloatMath.pow(ApfloatMath.abs(ApfloatMath.cos(new Apfloat(Tetat))), (new Apfloat(FatorCorrecaoAspectoTeta))), (new Apfloat(1)).divide(new Apfloat(FatorMaxCorrecaoAspectoTeta)))).add(ApfloatMath.sin(new Apfloat(Rott)).multiply(zoa.add(ApfloatMath.sqrt(xoa.multiply(xoa).add(yoa.multiply(yoa))).multiply(ApfloatMath.tan(new Apfloat(Phit))).divide(xoa.multiply(ApfloatMath.cos(new Apfloat(Tetat))).add(yoa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))).divide(ApfloatMath.max(ApfloatMath.pow(ApfloatMath.abs(ApfloatMath.cos(new Apfloat(Phit))), (new Apfloat(FatorCorrecaoAspectoPhi))), (new Apfloat(1)).divide(new Apfloat(FatorMaxCorrecaoAspectoPhi)))).multiply(new Apfloat(-1)))).doubleValue()) - CorrecaoX;
    
                    yi = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * (new Apfloat(DistanciaTela)).multiply(ApfloatMath.sin(new Apfloat(Rott)).multiply(xoa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).add(yoa.multiply(ApfloatMath.cos(new Apfloat(Tetat)))).divide(xoa.multiply(ApfloatMath.cos(new Apfloat(Tetat))).add(yoa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(new Apfloat(-1))))).divide(ApfloatMath.max(ApfloatMath.pow(ApfloatMath.abs(ApfloatMath.cos(new Apfloat(Tetat))), (new Apfloat(FatorCorrecaoAspectoTeta))), (new Apfloat(1)).divide(new Apfloat(FatorMaxCorrecaoAspectoTeta)))).add(ApfloatMath.cos(new Apfloat(Rott)).multiply(zoa.add(ApfloatMath.sqrt(xoa.multiply(xoa).add(yoa.multiply(yoa))).multiply(ApfloatMath.tan(new Apfloat(Phit)))).divide(xoa.multiply(ApfloatMath.cos(new Apfloat(Tetat))).add(yoa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(new Apfloat(-1))))).divide(ApfloatMath.max(ApfloatMath.pow(ApfloatMath.abs(ApfloatMath.cos(new Apfloat(Phit))), (new Apfloat(FatorCorrecaoAspectoPhi))), (new Apfloat(1)).divide(new Apfloat(FatorMaxCorrecaoAspectoPhi)))))).doubleValue()) - CorrecaoY;

                    xf = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * (new Apfloat(DistanciaTela)).multiply(ApfloatMath.cos(new Apfloat(Rott)).multiply(xda.multiply(ApfloatMath.sin(new Apfloat(Tetat))).add(yda.multiply(ApfloatMath.cos(new Apfloat(Tetat)))).divide(xda.multiply(ApfloatMath.cos(new Apfloat(Tetat))).add(yda.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(new Apfloat(-1))))).divide(ApfloatMath.max(ApfloatMath.pow(ApfloatMath.abs(ApfloatMath.cos(new Apfloat(Tetat))), (new Apfloat(FatorCorrecaoAspectoTeta))), (new Apfloat(1)).divide(new Apfloat(FatorMaxCorrecaoAspectoTeta)))).add(ApfloatMath.sin(new Apfloat(Rott)).multiply(zda.add(ApfloatMath.sqrt(xda.multiply(xda).add(yda.multiply(yda))).multiply(ApfloatMath.tan(new Apfloat(Phit))).divide(xda.multiply(ApfloatMath.cos(new Apfloat(Tetat))).add(yda.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))).divide(ApfloatMath.max(ApfloatMath.pow(ApfloatMath.abs(ApfloatMath.cos(new Apfloat(Phit))), (new Apfloat(FatorCorrecaoAspectoPhi))), (new Apfloat(1)).divide(new Apfloat(FatorMaxCorrecaoAspectoPhi)))).multiply(new Apfloat(-1)))).doubleValue()) - CorrecaoX;
        
                    yf = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * (new Apfloat(DistanciaTela)).multiply(ApfloatMath.sin(new Apfloat(Rott)).multiply(xda.multiply(ApfloatMath.sin(new Apfloat(Tetat))).add(yda.multiply(ApfloatMath.cos(new Apfloat(Tetat)))).divide(xda.multiply(ApfloatMath.cos(new Apfloat(Tetat))).add(yda.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(new Apfloat(-1))))).divide(ApfloatMath.max(ApfloatMath.pow(ApfloatMath.abs(ApfloatMath.cos(new Apfloat(Tetat))), (new Apfloat(FatorCorrecaoAspectoTeta))), (new Apfloat(1)).divide(new Apfloat(FatorMaxCorrecaoAspectoTeta)))).add(ApfloatMath.cos(new Apfloat(Rott)).multiply(zda.add(ApfloatMath.sqrt(xda.multiply(xda).add(yda.multiply(yda))).multiply(ApfloatMath.tan(new Apfloat(Phit)))).divide(xda.multiply(ApfloatMath.cos(new Apfloat(Tetat))).add(yda.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(new Apfloat(-1))))).divide(ApfloatMath.max(ApfloatMath.pow(ApfloatMath.abs(ApfloatMath.cos(new Apfloat(Phit))), (new Apfloat(FatorCorrecaoAspectoPhi))), (new Apfloat(1)).divide(new Apfloat(FatorMaxCorrecaoAspectoPhi)))))).doubleValue()) - CorrecaoY;
        ...
        for (int i = 0; i < EspacoPoligonosShapePreenchidos.length; i++)
            ...
            for (int j = 0; j < Pontos.length; j++)
                ...
                if (ApfloatFlag == 0)
                    ...
                    try
                        {
                        xpp = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * DistanciaTela * (Math.cos(Rott) * (xp * Math.sin(Tetat) + yp * Math.cos(Tetat)) / (xp * Math.cos(Tetat) - yp * Math.sin(Tetat)) / Math.max(Math.pow(Math.abs(Math.cos(Tetat)), FatorCorrecaoAspectoTeta), 1 / FatorMaxCorrecaoAspectoTeta) - Math.sin(Rott) * (zp + Math.sqrt(xp * xp + yp * yp) * Math.tan(Phit)) / (xp * Math.cos(Tetat) - yp * Math.sin(Tetat)) / Math.max(Math.pow(Math.abs(Math.cos(Phit)), FatorCorrecaoAspectoPhi), 1 / FatorMaxCorrecaoAspectoPhi))) - CorrecaoX;

                        ypp = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * DistanciaTela * (Math.sin(Rott) * (xp * Math.sin(Tetat) + yp * Math.cos(Tetat)) / (xp * Math.cos(Tetat) - yp * Math.sin(Tetat)) / Math.max(Math.pow(Math.abs(Math.cos(Tetat)), FatorCorrecaoAspectoTeta), 1 / FatorMaxCorrecaoAspectoTeta) + Math.cos(Rott) * (zp + Math.sqrt(xp * xp + yp * yp) * Math.tan(Phit)) / (xp * Math.cos(Tetat) - yp * Math.sin(Tetat)) / Math.max(Math.pow(Math.abs(Math.cos(Phit)), FatorCorrecaoAspectoPhi), 1 / FatorMaxCorrecaoAspectoPhi))) - CorrecaoY;
                    ...
                    try
                        {
                        xpp = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * (new Apfloat(DistanciaTela)).multiply(ApfloatMath.cos(new Apfloat(Rott)).multiply(xpa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).add(ypa.multiply(ApfloatMath.cos(new Apfloat(Tetat)))).divide(xpa.multiply(ApfloatMath.cos(new Apfloat(Tetat))).add(ypa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(new Apfloat(-1))))).divide(ApfloatMath.max(ApfloatMath.pow(ApfloatMath.abs(ApfloatMath.cos(new Apfloat(Tetat))), (new Apfloat(FatorCorrecaoAspectoTeta))), (new Apfloat(1)).divide(new Apfloat(FatorMaxCorrecaoAspectoTeta)))).add(ApfloatMath.sin(new Apfloat(Rott)).multiply(zpa.add(ApfloatMath.sqrt(xpa.multiply(xpa).add(ypa.multiply(ypa))).multiply(ApfloatMath.tan(new Apfloat(Phit))).divide(xpa.multiply(ApfloatMath.cos(new Apfloat(Tetat))).add(ypa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(ApfloatMath.cos(new Apfloat(Phit))).multiply(new Apfloat(-1)))))).divide(ApfloatMath.max(ApfloatMath.pow(ApfloatMath.abs(ApfloatMath.cos(new Apfloat(Phit))), (new Apfloat(FatorCorrecaoAspectoPhi))), (new Apfloat(1)).divide(new Apfloat(FatorMaxCorrecaoAspectoPhi)))).multiply(new Apfloat(-1)))).doubleValue()) - CorrecaoX;
        
                        ypp = (int) (Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 + Math.min(TamanhoPlanoX, TamanhoPlanoY) / 2 * (new Apfloat(DistanciaTela)).multiply(ApfloatMath.sin(new Apfloat(Rott)).multiply(xpa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).add(ypa.multiply(ApfloatMath.cos(new Apfloat(Tetat)))).divide(xpa.multiply(ApfloatMath.cos(new Apfloat(Tetat))).add(ypa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(new Apfloat(-1))))).divide(ApfloatMath.max(ApfloatMath.pow(ApfloatMath.abs(ApfloatMath.cos(new Apfloat(Tetat))), (new Apfloat(FatorCorrecaoAspectoTeta))), (new Apfloat(1)).divide(new Apfloat(FatorMaxCorrecaoAspectoTeta)))).add(ApfloatMath.cos(new Apfloat(Rott)).multiply(zpa.add(ApfloatMath.sqrt(xpa.multiply(xpa).add(ypa.multiply(ypa))).multiply(ApfloatMath.tan(new Apfloat(Phit)))).divide(xpa.multiply(ApfloatMath.cos(new Apfloat(Tetat))).add(ypa.multiply(ApfloatMath.sin(new Apfloat(Tetat))).multiply(new Apfloat(-1))))).divide(ApfloatMath.max(ApfloatMath.pow(ApfloatMath.abs(ApfloatMath.cos(new Apfloat(Phit))), (new Apfloat(FatorCorrecaoAspectoPhi))), (new Apfloat(1)).divide(new Apfloat(FatorMaxCorrecaoAspectoPhi)))))).doubleValue()) - CorrecaoY;
