...
#define ARQUIVO_MATHSOBRE "antoniovandre_sobre_windows.txt"

#define ARQUIVO_MATH_ESTATISTICAS "antoniovandre_math_estatisticas_windows.txt"
#define ESCREVER_ESTATISTICAS FALSIDADE

#define ARQUIVO_PRECISAO_REAL "antoniovandre_precisao_real_windows.txt"
