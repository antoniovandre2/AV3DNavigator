...
int main (int argc, char * argv[])
	...
	for (i = 0; i < argi; i++)
		...
		for (j = 0; j < resolucao; j++)
			{
			printf("%Lf,%Lf,0;%Lf,%Lf,0;%Lf,%Lf,0;%Lf,%Lf,0c%s|", r * cosl(j * 2 * M_PI / resolucao) / soma, r * sinl(j * 2 * M_PI / resolucao) / soma, r * cosl((j + 1) * 2 * M_PI / resolucao) / soma, r * sinl((j + 1) * 2 * M_PI / resolucao) / soma, R * cosl((j + 1) * 2 * M_PI / resolucao) / soma, R * sinl((j + 1) * 2 * M_PI / resolucao) / soma, R * cosl(j * 2 * M_PI / resolucao) / soma, R * sinl(j * 2 * M_PI / resolucao) / soma, rgb[i]);

			fflush(stdout);

			printf("%Lf,%Lf,%Lf;%Lf,%Lf,%Lf;%Lf,%Lf,%Lf;%Lf,%Lf,%Lfc%s|", r * cosl(j * 2 * M_PI / resolucao) / soma, r * sinl(j * 2 * M_PI / resolucao) / soma, espessura, r * cosl((j + 1) * 2 * M_PI / resolucao) / soma, r * sinl((j + 1) * 2 * M_PI / resolucao) / soma, espessura, R * cosl((j + 1) * 2 * M_PI / resolucao) / soma, R * sinl((j + 1) * 2 * M_PI / resolucao) / soma, espessura, R * cosl(j * 2 * M_PI / resolucao) / soma, R * sinl(j * 2 * M_PI / resolucao) / soma, espessura, rgb[i]);
	...
	for (j = 0; j < resolucao; j++)
		{
		printf("%Lf,%Lf,%Lf;%Lf,%Lf,%Lf;%Lf,%Lf,0;%Lf,%Lf,0c%s|", R * cosl(j * 2 * M_PI / resolucao) / soma, R * sinl(j * 2 * M_PI / resolucao) / soma, espessura, R * cosl((j + 1) * 2 * M_PI / resolucao) / soma, R * sinl((j + 1) * 2 * M_PI / resolucao) / soma, espessura, R * cosl((j + 1) * 2 * M_PI / resolucao) / soma, R * sinl((j + 1) * 2 * M_PI / resolucao) / soma, R * cosl(j * 2 * M_PI / resolucao) / soma, R * sinl(j * 2 * M_PI / resolucao) / soma, rgb[argi - 1]);
