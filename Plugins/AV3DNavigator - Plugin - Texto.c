                        ...
                        if ((flagfonteencontrada == 1) && (flagquadrilateros == 0)) if ((fontstring[k] == 'q') && (fontstring[k - 1] != '|'))
                            ...
                            do
                                ...
                                for (t = 0; t < resolucao; t++)
                                    ...
                                    printf("%f,%f,%f;%f,%f,%f;%f,%f,%f;", ((vx1 + t * (vx4 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + p1 + posxvaloresnumericos[i], ((vx1 + t * (vx4 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + p2 + posyvaloresnumericos[i], (vy1 + t * (vy4 - vy1) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vx2 + t * (vx3 - vx2) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + p1 + posxvaloresnumericos[i], ((vx2 + t * (vx3 - vx2) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + p2 + posyvaloresnumericos[i], (vy2 + t * (vy3 - vy2) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vx1 + (t + 1) * (vx4 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + p1 + posxvaloresnumericos[i], ((vx1 + (t + 1) * (vx4 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + p2 + posyvaloresnumericos[i], (vy1 + (t + 1) * (vy4 - vy1) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i]);

                                    fflush(stdout);

                                    printf("%f,%f,%fc%s|", ((vx2 + (t + 1) * (vx3 - vx2) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + p1 + posxvaloresnumericos[i], ((vx2 + (t + 1) * (vx3 - vx2) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + p2 + posyvaloresnumericos[i], (vy2 + (t + 1) * (vy3 - vy2) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], rgb[i]);
                                    ...
                                    printf("%f,%f,%f;%f,%f,%f;%f,%f,%f;", ((vx1 + t * (vx4 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx1 + t * (vx4 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy1 + t * (vy4 - vy1) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vx1 + t * (vx4 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(M_PI_2 + tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx1 + t * (vx4 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy1 + t * (vy4 - vy1) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vx1 + (t + 1) * (vx4 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(M_PI_2 + tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx1 + (t + 1) * (vx4 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy1 + (t + 1) * (vy4 - vy1) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i]);

                                    fflush(stdout);

                                    printf("%f,%f,%fc%s|", ((vx1 + (t + 1) * (vx4 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx1 + (t + 1) * (vx4 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy1 + (t + 1) * (vy4 - vy1) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], rgb[i]);

                                    fflush(stdout);

                                   printf("%f,%f,%f;%f,%f,%f;%f,%f,%f;", ((vx1 + t * (vx2 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx1 + t * (vx2 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy1 + t * (vy2 - vy1) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vx1 + t * (vx2 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(M_PI_2 + tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx1 + t * (vx2 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy1 + t * (vy2 - vy1) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vx1 + (t + 1) * (vx2 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(M_PI_2 + tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx1 + (t + 1) * (vx2 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy1 + (t + 1) * (vy2 - vy1) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i]);

                                    fflush(stdout);

                                    printf("%f,%f,%fc%s|", ((vx1 + (t + 1) * (vx2 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx1 + (t + 1) * (vx2 - vx1) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy1 + (t + 1) * (vy2 - vy1) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], rgb[i]);

                                    fflush(stdout);

                                    printf("%f,%f,%f;%f,%f,%f;%f,%f,%f;", ((vx2 + t * (vx3 - vx2) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx2 + t * (vx3 - vx2) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy2 + t * (vy3 - vy2) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vx2 + t * (vx3 - vx2) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(M_PI_2 + tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx2 + t * (vx3 - vx2) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy2 + t * (vy3 - vy2) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vx2 + (t + 1) * (vx3 - vx2) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(M_PI_2 + tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx2 + (t + 1) * (vx3 - vx2) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy2 + (t + 1) * (vy3 - vy2) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i]);

                                    fflush(stdout);

                                    printf("%f,%f,%fc%s|", ((vx2 + (t + 1) * (vx3 - vx2) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx2 + (t + 1) * (vx3 - vx2) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy2 + (t + 1) * (vy3 - vy2) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], rgb[i]);

                                    fflush(stdout);

                                    printf("%f,%f,%f;%f,%f,%f;%f,%f,%f;", ((vx3 + t * (vx4 - vx3) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx3 + t * (vx4 - vx3) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy3 + t * (vy4 - vy3) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vx3 + t * (vx4 - vx3) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(M_PI_2 + tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx3 + t * (vx4 - vx3) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy3 + t * (vy4 - vy3) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vx3 + (t + 1) * (vx4 - vx3) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(M_PI_2 + tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx3 + (t + 1) * (vx4 - vx3) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy3 + (t + 1) * (vy4 - vy3) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i]);

                                    fflush(stdout);

                                    printf("%f,%f,%fc%s|", ((vx3 + (t + 1) * (vx4 - vx3) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vx3 + (t + 1) * (vx4 - vx3) / resolucao) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vy3 + (t + 1) * (vy4 - vy3) / resolucao) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], rgb[i]);
                        ...
                        if ((flagfonteencontrada == 1) && (flagcurvas == 0)) if ((fontstring[k] == 'c') && (fontstring[k - 1] != '|'))
                            ...
                            do
                                ...
                                for (t = 0; t < resolucao; t++)
                                    ...
                                    printf("%f,%f,%f;%f,%f,%f;%f,%f,%f;", ((vcx + vr1 * cos(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + p1 + posxvaloresnumericos[i], ((vcx + vr1 * cos(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + p2 + posyvaloresnumericos[i], (vcy + vr1 * sin(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vcx + vr2 * cos(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + p1 + posxvaloresnumericos[i], ((vcx + vr2 * cos(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + p2 + posyvaloresnumericos[i], (vcy + vr2 * sin(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vcx + vr2 * cos(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + p1 + posxvaloresnumericos[i], ((vcx + vr2 * cos(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + p2 + posyvaloresnumericos[i], (vcy + vr2 * sin(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i]);

                                    fflush(stdout);

                                    printf("%f,%f,%fc%s|", ((vcx + vr1 * cos(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + p1 + posxvaloresnumericos[i], ((vcx + vr1 * cos(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + p2 + posyvaloresnumericos[i], (vcy + vr1 * sin(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], rgb[i]);
                                    ...
                                    printf("%f,%f,%f;%f,%f,%f;%f,%f,%f;", ((vcx + vr1 * cos(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vcx + vr1 * cos(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vcy + vr1 * sin(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vcx + vr1 * cos(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(M_PI_2 + tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vcx + vr1 * cos(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vcy + vr1 * sin(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vcx + vr1 * cos(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(M_PI_2 + tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vcx + vr1 * cos(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vcy + vr1 * sin(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i]);

                                    fflush(stdout);

                                    printf("%f,%f,%fc%s|", ((vcx + vr1 * cos(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vcx + vr1 * cos(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vcy + vr1 * sin(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], rgb[i]);

                                    fflush(stdout);

                                    printf("%f,%f,%f;%f,%f,%f;%f,%f,%f;", ((vcx + vr2 * cos(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vcx + vr2 * cos(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vcy + vr2 * sin(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vcx + vr2 * cos(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(M_PI_2 + tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vcx + vr2 * cos(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vcy + vr2 * sin(vai + t * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], ((vcx + vr2 * cos(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(M_PI_2 + tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vcx + vr2 * cos(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + profundidadevaloresnumericos[i] * cos(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vcy + vr2 * sin(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i]);

                                    fflush(stdout);

                                    printf("%f,%f,%fc%s|", ((vcx + vr2 * cos(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * cos(tetavaloresnumericos[i]) + posxvaloresnumericos[i], ((vcx + vr2 * cos(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + shiftlateral) * sin(tetavaloresnumericos[i]) + posyvaloresnumericos[i], (vcy + vr2 * sin(vai + (t + 1) * (vaf - vai) / resolucao)) * tamanhovaloresnumericos[i] + poszvaloresnumericos[i], rgb[i]);

                                    fflush(stdout);

                                    if (max < vcx + vr1 * cos(vai)) max = vcx + vr1 * cos(vai);

                                    if (max < vcx + vr1 * cos(vai + (t + 1) * (vaf - vai) / resolucao))
                                        max = vcx + vr1 * cos(vai + (t + 1) * (vaf - vai) / resolucao);

                                    if (max < vcx + vr2 * cos(vai)) max = vcx + vr2 * cos(vai);

                                    if (max < vcx + vr2 * cos(vai + (t + 1) * (vaf - vai) / resolucao))
                                        max = vcx + vr2 * cos(vai + (t + 1) * (vaf - vai) / resolucao);
                                    }
